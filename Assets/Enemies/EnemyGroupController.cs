...
public class EnemyGroupController : MonoBehaviour
{
    ...
    public void DestroyEnemy(EnemyModel enemy, Vector2 mapChunk) { 
    ...
    public void Pause() {
        enemyList[cameraPosisiton.currentMapChunk]?.ForEach(e => e.Pause());
    }

    public void Resume() {
        enemyList[cameraPosisiton.currentMapChunk]?.ForEach(e => e.Resume());
    }
}
